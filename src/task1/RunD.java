...
public class RunD {
    public static void main(String[] args) {
        ...
        for (Student student : students) {
            if (isFirstFindBySchool(students, student)) {
                System.out.println(student.getSchool());
            }
        }
    }

    private static boolean isFirstFindBySchool(Student[] students, Student student) {
        for (Student elem : students) {
            if (elem.getSchool().equals(student.getSchool())) {
